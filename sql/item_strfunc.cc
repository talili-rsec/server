...
String *Item_func_transliterate::val_str(String *str)
{
  ...
  const String *hwkatakana_fwkatakana_mode= new String("hwkatakana_fwkatakana", 21,
      name->charset());
  const String *fwkatakana_hwkatakana_mode= new String("fwkatakana_hwkatakana", 21,
      name->charset());
  ...
  if (name->eq(hwkatakana_fwkatakana_mode, name->charset()) || name->eq(kana_hiragana_mode, name->charset()))
  {
